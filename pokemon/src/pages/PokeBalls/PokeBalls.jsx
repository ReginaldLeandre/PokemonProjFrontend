...
const PokeBalls = () => {
    return (
        <div className="sm:flex gap-[50px] w-max mx-auto mt-10">
            <div className="w-[240px] border-[2px]" name="ballType" value="PokeBall">
            ...
            <div className="w-[240px] border-[2px]" name="ballType" value="GreatBall">
            ...
            <div className="w-[240px] border-[2px]" name="ballType" value="UltraBall">
            ...
            <div className="w-[240px] border-[2px]" name="ballType" value="MasterBall">
