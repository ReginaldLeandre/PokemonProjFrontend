            ...
            <div className="lg:flex">
              ...
              {cartData.pokeBallItems.map((p, index) => (
                <div key={index}>
                  ...
                  <div key={index} className="border-[8px] border-poke-yellow rounded-md bg-poke-lightyellow w-[240px] sm:w-[513.5px] lg:w-[680px] min-w-max mx-auto flex flex-col sm:flex-row mb-6 text-lg">
                    <div className="my-4 mx-auto sm:mx-4 flex items-center w-[96px] h-[96px] sm:my-auto sm:min-w-[96px] sm:min-h-[96px] bg-gradient-to-tr from-green-700 via-teal-400 to-blue-300">
                      <img className="max-w-[70px] mx-auto" src={PokeBall} alt="Poke Ball" />
                    </div>
                    <div className="sm:mx-6 w-full my-auto">
                  ...
                  {(p.pokeBall.ballType === 'GreatBall') && (
                    <div key={index} className="border-[8px] border-poke-yellow rounded-md bg-poke-lightyellow w-[240px] sm:w-[513.5px] lg:w-[680px] min-w-max mx-auto flex flex-col sm:flex-row mb-6 text-lg">
                    <div className="my-4 mx-auto sm:mx-4 flex items-center w-[96px] h-[96px] sm:my-auto sm:min-w-[96px] sm:min-h-[96px] bg-gradient-to-tr from-green-700 via-teal-400 to-blue-300">
                      <img className="max-w-[70px] mx-auto" src={GreatBall} alt="Great Ball" />
                    </div>
                    <div className="sm:mx-6 w-full my-auto">
                  ...
                  {(p.pokeBall.ballType === 'UltraBall') && (
                    <div key={index} className="border-[8px] border-poke-yellow rounded-md bg-poke-lightyellow w-[240px] sm:w-[513.5px] lg:w-[680px] min-w-max mx-auto flex flex-col sm:flex-row mb-6 text-lg">
                    <div className="my-4 mx-auto sm:mx-4 flex items-center w-[96px] h-[96px] sm:my-auto sm:min-w-[96px] sm:min-h-[96px] bg-gradient-to-tr from-green-700 via-teal-400 to-blue-300">
                      <img className="max-w-[70px] mx-auto" src={UltraBall} alt="Ultra Ball" />
                    </div>
                    <div className="sm:mx-6 w-full my-auto">
                  ...
                  {(p.pokeBall.ballType === 'MasterBall') && (
                    <div key={index} className="border-[8px] border-poke-yellow rounded-md bg-poke-lightyellow w-[240px] sm:w-[513.5px] lg:w-[680px] min-w-max mx-auto flex flex-col sm:flex-row mb-6 text-lg">
                    <div className="my-4 mx-auto sm:mx-4 flex items-center w-[96px] h-[96px] sm:my-auto sm:min-w-[96px] sm:min-h-[96px] bg-gradient-to-tr from-green-700 via-teal-400 to-blue-300">
                      <img className="max-w-[70px] mx-auto" src={MasterBall} alt="Master Ball" />
                    </div>
                    <div className="sm:mx-6 w-full my-auto">
                    ...
                    <div className="mx-auto sm:mx-0 flex my-auto min-w-[90px]">
                      <p className="my-auto mr-2">Qty: </p>
                      <div className="my-auto flex flex-col items-center">
                        <span className="border-[gray] bg-white py-1 px-2 mt-[18px]">{p.quantity}</span>
                        <BsCaretDownFill onClick={() => handleDecreasePokeBall(p.pokeBall.ballType)} className="hover:cursor-pointer hover:text-[20px] mt-1"/>
                      </div>
                    </div>
                    <div className="flex align-center items-center min-w-[80px] sm:min-w-[130px]">
